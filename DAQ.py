...
def argument_parser():
    ...
    parser.add_argument(
        "--f1", dest="f1", type=eng_float, default=eng_notation.num_to_str(float(1.418e9)),
        help="Set Chan 1 freq [default=%(default)r]")
    parser.add_argument(
        "--f2", dest="f2", type=eng_float, default=eng_notation.num_to_str(float(1418e6)),
        help="Set Chan 2 freq [default=%(default)r]")
    parser.add_argument(
        "--f3", dest="f3", type=eng_float, default=eng_notation.num_to_str(float(1418e6)),
    ...
    parser.add_argument(
        "--samp-rate", dest="samp_rate", type=eng_float, default=eng_notation.num_to_str(float(1.0e7)),
