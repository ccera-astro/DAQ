...
class Polycos:
    ...
    def generate_polycos(
        ...
        Polycos
        """
        print("\n ****\nEntering generate_polycos(): mjdStart={0} mjdStop={1} segLength={2}".format(
            mjdStart,mjdEnd,segLength))
        ...
        #line = "tmids="
        #for tmid in tmids : line += " {0}".format(tmid)
        #print(line)
        ...
        for tmid in tqdm(tmids, disable=True):
            ...
            #print("\ntmid={0:f} refPhase={1:s}".format(tmid,str(refPhase)))
            ...
            print("coeffs={0:s}".format(str(coeffs)))
